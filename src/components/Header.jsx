    ...
    <header className="flex items-center justify-between px-4 py-2 bg-white sticky top-0 z-50 h-14">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-1 cursor-pointer">
          <div className="bg-red-600 text-white font-bold px-2 py-1 rounded text-xs">YT</div>
      ...
      <div className="flex items-center">
        <button className="flex items-center gap-2 px-4 py-1.5 text-blue-600 border border-gray-200 rounded-full hover:bg-blue-50 font-medium">
